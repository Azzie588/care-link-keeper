...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "MedTrack" },
      { property: "og:title", content: "MedTrack — Family medical tracker" },
      { property: "og:description", content: "A simple, shared place to keep your family's providers, appointments, and medications." },
